...
class DownloaderActivity : ComponentActivity() {
    private val alertUtil = AlertUtil(this@DownloaderActivity)
    private val shareUtil = ShareUtil(this@DownloaderActivity)
    private val toastUtil = ToastUtil(this@DownloaderActivity)
    private val viewUtil = ViewUtil(this@DownloaderActivity)
                ...
                topBar = {
                    TopAppBar(
                        modifier = Modifier
                            ...
                            .fillMaxWidth(),
                        title = {
                            Text(text = getString(R.string.title_activity_downloader))
                        },
                        actions = {
                            Icon(
